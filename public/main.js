...
const cardsDealt = () => {
    ...
    newLi.textContent = 'The player has ' + playerHand[playerIndex].rank + ' of ' + playerHand[playerIndex].suit;
...
const hitMe = () => {
	...
	const newLi2 = document.createElement('li');
	// New line writes the player's hand calling the index values each iteration
	newLi.textContent = 'The player has ' + playerHand[2].rank + ' of ' + playerHand[2].suit;
...
let exitGame = () => {
	...
	if (dealerTotal < 17) {
		...
		// New line writes the player's hand calling the index values each iteration
		newLi.textContent = 'The dealer has ' + dealerHand[0].rank + ' of ' + dealerHand[0].suit;
		newLi2.textContent = +dealerHand[1].rank + ' of ' + dealerHand[1].suit;
		newLi3.textContent = 'and a ' + dealerHand[2].rank + ' of ' + dealerHand[2].suit;
		...
		// New line writes the player's hand calling the index values each iteration
		newLi.textContent = 'The dealer has ' + dealerHand[0].rank + ' of ' + dealerHand[0].suit;
		newLi2.textContent = 'and a ' + dealerHand[1].rank + ' of ' + dealerHand[1].suit;
